...
async function deployProject(filePath, siteName, options = {}) {
  ...
  try {
    ...
    previewProcess.on('exit', (code, signal) => {
      // #region agent log
      fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H2',location:'lib/deployment-manager.js:1614',message:'preview process exited',data:{deploymentId,subdomain,pid:previewProcess.pid,serverPort,code,signal},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
    });
...
async function removeDeployment(deploymentId) {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H3',location:'lib/deployment-manager.js:1678',message:'removeDeployment called (demo cleanup / manual remove)',data:{deploymentId:deploymentId,subdomain:deployment.subdomain,pid:deployment.pid,port:deployment.port,is_demo:deployment.is_demo},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
  ...
  try {
    if (deployment.pid) {
      ...
      try {
        // #region agent log
        fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H5',location:'lib/deployment-manager.js:1683',message:'removeDeployment attempting SIGTERM on process group',data:{deploymentId,subdomain:deployment.subdomain,pid:deployment.pid,port:deployment.port},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        ...
        setTimeout(() => {
          try {
            // #region agent log
            fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H5',location:'lib/deployment-manager.js:1689',message:'removeDeployment attempting SIGKILL on process group',data:{deploymentId,subdomain:deployment.subdomain,pid:deployment.pid,port:deployment.port},timestamp:Date.now()})}).catch(()=>{});
            // #endregion
        ...
        if (deployment.port) {
          // #region agent log
          fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H5',location:'lib/deployment-manager.js:1697',message:'removeDeployment group kill failed; falling back to port-based kill',data:{deploymentId,subdomain:deployment.subdomain,pid:deployment.pid,port:deployment.port,errMessage:err?.message},timestamp:Date.now()})}).catch(()=>{});
          // #endregion
...
async function cleanupExpiredDemoDeployments() {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H3',location:'lib/deployment-manager.js:1762',message:'cleanupExpiredDemoDeployments selection',data:{now,expiredCount:expired.length,expiredIds:expired.slice(0,5).map(d=>d.id)},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
...
async function restartDeployment(deploymentId) {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7321/ingest/1f8d5258-140b-4575-a452-3cf09e8fea30',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'b5753b'},body:JSON.stringify({sessionId:'b5753b',runId:'pre',hypothesisId:'H6',location:'lib/deployment-manager.js:1840',message:'restartDeployment started preview',data:{deploymentId,subdomain:deployment.subdomain,framework,port:serverPort,pid:pid || previewProcess.pid},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
